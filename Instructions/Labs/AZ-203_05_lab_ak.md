...
1.  Within the command prompt, enter the following command and press Enter to clone the **michaelfery/AZ-203-DevelopingSolutionsforMicrosoftAzure** project hosted on GitHub into the **User (C):\\Users\\formation** drive:
...
1.  In the File Explorer pane that opens, go to **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\05\\Starter\\Api**, and then select **Select Folder**.
...
1.  In the File Explorer pane that opens, go to **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\Starter\\Api**, and then select **Select Folder**.
...
1. Enter the following command and press Enter to change the current directory to the **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\05\\Starter** directory that contains the deployment files:

    ```powershell
    cd C:\Users\formation\AZ-203-DevelopingSolutionsforMicrosoftAzure\Allfiles\Labs\05\Starter\
    ```
...
1.  In the File Explorer pane that opens, go to **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Starter\\Console**, and then select **Select Folder**.
...
1. In the File Explorer pane that opens, go to **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\05\\Starter\\Console**, and then select **Select Folder**.
...
1. Observe that the application execution fails and displays a **HttpRequestException** message that is similar to the following exception message:
    ...
    at SimpleConsole.Program.Run() in C:\Users\formation\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\Labs\05\Starter\Console\Program.cs:line 20
    ```
