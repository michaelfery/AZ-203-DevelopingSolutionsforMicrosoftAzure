...
1.  In the PowerShell command prompt, change the current working directory to the **C:\\Users\\formation** path:

    ```powershell
    cd C:\Users\formation
    ```

1.  Within the command prompt, enter the following command and press Enter to clone the **microsoftlearning/AZ-203-DevelopingSolutionsforMicrosoftAzure** project hosted on GitHub into the **C:\\Users\\formation** drive:
...
1. In the **File Explorer** dialog box that opens, perform the following actions:
    ...
    1.  Go to **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\06\\Starter**.
