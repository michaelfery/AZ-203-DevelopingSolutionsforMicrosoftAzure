...
1.  In the **Products Table** tab, select **Import** and import the **products.csv** file located in the **C:\\Users\\formation\\AZ-203-DevelopingSolutionsforMicrosoftAzure\\Allfiles\\Labs\\06\\Starter** folder on your lab machine.
